<template>
  <div class="main-container">
    ...
    <main-header menuLink="Works" :menuItemsList="menuItemsList"></main-header>
...
const menuItemsList = ref([{ title: 'Web', slotName: 'me' }, { title: 'Mobile', slotName: 'music' }, { title: 'Desktop', slotName: 'music' }])
